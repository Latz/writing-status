            ...
            <ul class="writing-status-list">
                ...
                ?>
                    <li class="writing-status-item">
                        <a href="<?php echo esc_url(get_edit_post_link($post_id)); ?>" class="writing-status-item-link" aria-label="<?php echo esc_attr(sprintf(__('Edit %s draft: %s, last modified %s', 'writing-status'), $status_text, get_the_title(), get_the_modified_date())); ?>">
