...
define( 'WRITING_STATUS_VERSION', '1.9.25' );
...
class WritingStatus extends WritingStatusRenderer {
	...
	public function saveBulkEdit( $post_id ) {
		...
		// Nonce already verified by isValidBulkEditRequest() above.
	...
	public static function migrateMetaKeys() {
		...
		// One-time meta-key rename on activation, not a cacheable read query;
		// 'meta_key' below is a column name for $wpdb->update(), not a WP_Query arg.
